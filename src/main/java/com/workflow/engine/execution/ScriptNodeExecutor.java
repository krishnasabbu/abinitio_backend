...
/**
 * Executor for script nodes that evaluate inline scripts during workflow processing.
 */
@Component
public class ScriptNodeExecutor implements NodeExecutor<Map<String, Object>, Map<String, Object>> {
    ...
    public ItemProcessor<Map<String, Object>, Map<String, Object>> createProcessor(NodeExecutionContext context) {
        ...
        String nodeId = context.getNodeDefinition().getId();
        logger.debug("ScriptNode node {} processing", nodeId);
        return item -> item;
    }
    ...
    public ItemWriter<Map<String, Object>> createWriter(NodeExecutionContext context) {
        return items -> {
            logger.info("ScriptNodeExecutor writing {} items", items.getItems().size());
    ...
    public void validate(NodeExecutionContext context) {
        JsonNode config = context.getNodeDefinition().getConfig();
        if (config == null) {
            throw new IllegalArgumentException("nodeType=ScriptNode, nodeId=" + context.getNodeDefinition().getId()

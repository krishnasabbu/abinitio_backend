...
/**
 * Executor for database execution nodes that run SQL queries against configured data sources.
 */
@Component
public class DBExecuteExecutor implements NodeExecutor<Map<String, Object>, Map<String, Object>> {
    ...
    public ItemWriter<Map<String, Object>> createWriter(NodeExecutionContext context) {
        return items -> {
            logger.info("DBExecuteExecutor writing {} items", items.getItems().size());
